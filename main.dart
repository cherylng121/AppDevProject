...
class _ProgressPageState extends State<ProgressPage> {
  ...
  Future<void> _addProgress() async {
    ...
    if (_selectedStudentUsername == null || _selectedStudentId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
    ...
    try {
      ...
      final record = {
        ...
        'studentId': _selectedStudentId, // Use the stored student ID
      ...
      setState(() {
        ...
        _selectedStudentId = null; // Clear the stored ID too
        _searchController.clear();
