...
class ProgressRecord {
  ...
  final String? studentId; // NEW: For better filtering
  final String activity;
  final double score;
  final String grade;
  final String comments;
  final Timestamp? timestamp;
  final bool isAutoGenerated; // NEW: To distinguish auto vs manual
  ...
  ProgressRecord({
    ...
    required this.timestamp,
    this.isAutoGenerated = false, // Default to manual entry
  });
...
return ListView.builder(
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          // Calculate analytics
          final analytics = _calculateAnalytics(records);
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 4. STUDENT COMPLETION STATUS
                _buildCompletionStatusCard(analytics),
              ],
            ),
          );
        },
  ...
  Map<String, dynamic> _calculateAnalytics(List<ProgressRecord> records) {
    ...
    final completionRate = uniqueStudents.isEmpty 
        ? 0.0 
        : (studentsWithQuizzes.length / uniqueStudents.length) * 100;
  ...
  // 4. STUDENT COMPLETION STATUS
  Widget _buildCompletionStatusCard(Map<String, dynamic> analytics) {
    final totalStudents = analytics['totalStudents'] as int;
    final studentsWithQuizzes = analytics['studentsWithQuizzes'] as int;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  '$studentsWithQuizzes out of $totalStudents students',
            ...
            const SizedBox(height: 8),
            Text(
              'Students who have completed at least one quiz',
              style: TextStyle(fontSize: 12, color: Colors.grey[600]),
            ),
          ],
        ),
